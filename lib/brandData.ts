...
export const brands: BrandData[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Yes — the Tissot PRX Powermatic 80 remains one of the best watches for the money in any category. Swiss-made, Powermatic 80 movement (80-hour power reserve, ±2.5 seconds/day accuracy), sapphire crystal, integrated bracelet, and a design that captures the luxury sports watch aesthetic at $550–625. Preowned examples regularly appear under $450. It has been backordered since launch for good reason.',
      },
      {
    ...
    faq: [
      {
        ...
        answer: 'Both — Cartier is simultaneously one of the world\'s leading jewellers and a respected watchmaker. The brand\'s strongest watch designs (Santos, Tank, Panthère) are as recognizable as any Rolex sport model. Cartier watches hold unusual cultural appeal because they cross the boundary between watchmaking and fashion jewellery, appealing to audiences who might not define themselves as watch enthusiasts. This breadth of appeal supports strong resale values.',
      },
      {
  ...
  },
  {
    ...
    overview: `Grand Seiko was established in 1960 as Seiko's pursuit of the ultimate wristwatch — in direct competition with Swiss standards. Made in dedicated ateliers in Shinshu (home of the Spring Drive) and Shizukuishi, Grand Seiko applies Zaratsu hand-polishing to create mirror-flat surfaces that distinguish its case finishing from virtually all other watchmakers at any price. The brand's signature movements — the Spring Drive (accuracy ±1 second/day), Hi-Beat automatic (36,000 bph), and manual wind calibers — represent genuine horological innovation. Grand Seiko dials (Snowflake, Birch, Cherry Blossom, seasons series) are made with natural materials and textures that create dials of extraordinary beauty. The brand operates independently from regular Seiko with its own ambassador program and design identity.`,
    faq: [
      {
  ...
  },
  {
    ...
    country: 'Switzerland',
    founded: 1988,
    watchBrand: 'Frédérique Constant',
